...
<template>
  <div id="b-container" class="container b-container">
    <form id="b-form" class="form" method="" action="">
      ...
      <input v-model="loginFrom.username" class="form__input" type="text" placeholder="用户名">
      <input v-model.lazy="loginFrom.password" class="form__input" type="password" placeholder="密码">
